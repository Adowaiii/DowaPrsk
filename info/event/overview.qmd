...
### Table Head
display(
    HTML('<table cellpadding="5"><thead style="text-align:center;"><tr><th>期數</th><th></th><th>屬性</th><th></th><th>活動名稱</th><th>團體</th><th>主角</th><th>開始日期</th><th>結束日期</th><th>活動模式</th><th>活動類型</th></tr></thead><tbody style="text-align:center;">'))
### Table Body => Data Set
for i in range(len(df)):
    ...
    display(
    HTML('<tr><td data-cell="期數">'+str(df.iloc[i][0])+'</td><td><img id="banner" src="'+str(df.iloc[i][1])+'"></td><td data-cell="屬性"><img id="attr" src="'+attr+'"></td><td>'+key+'</td><td data-cell="活動名稱">'+str(df.iloc[i][3])+'</td><td data-cell="團體">'+str(df.iloc[i][4])+'</td><td data-cell="主角">'+str(df.iloc[i][5])+'</td><td data-cell="開始日期">'+str(df.iloc[i][6])+'</td><td data-cell="結束日期">'+str(df.iloc[i][7])+'</td><td data-cell="活動模式">'+str(df.iloc[i][8])+'</td><td data-cell="活動類型" class="eventRarity">'+str(df.iloc[i][9])+'</td></tr>')
    )
