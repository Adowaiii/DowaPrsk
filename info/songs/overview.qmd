...
tabulate(
      df, 
      headers=["ID", "名稱", "實裝日期", "Easy", "Normal", "Hard", "Expert", "Master", "團體", "時長", "Easy鍵數", "Normal鍵數", "Hard鍵數", "Expert鍵數", "Master鍵數", "作詞", "作曲", "編曲"], tablefmt="html", stralign="center", colalign="center", showindex=False
    )
